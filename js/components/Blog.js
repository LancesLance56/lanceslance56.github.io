    ...
    return {
      posts: [
        ...
        },
        {
          ...
          content: `
            <p>The Hokkien language is an integral verbal practice to the Filipino-Chinese community of the Philippines. It is a form of communication that although is widespread amongst Chinese communities within Southeast Asia and southern China, still is unique given the context of the Chinese-Filipino. Lang-nang-oe（咱人話) (also known as the Philippine Hybrid Hokkien or PHH) is a distinct form of Hokkien born to the Filipino-Chinese community of Fujian and Guangdong descent that combines Tagalog, English and Hokkien. It is the face of this distinct community’s identity and symbolizes the community spirit, cultural heritage, as well as the survival of the Chinese-Filipino legacy.</p>
            
            <h4 class="text-white">Historical Background & Today's Adaptation</h4>
            <p>Majority of the Filipino-Chinese have roots in the Chinese province of Fujian (福建), where Hokkien originated as a southern dialect of the Min language. This dialect was later on brought to the Philippines via trade between China and the Philippines, and Chinese Migrants (from Guangdong and Fujian) during the 16th-19th centuries and strengthened from the 19th-20th centuries. </p>
            <p>In modern-day Philippine society, Hokkien has evolved to become Lang-nang-oe, and is typically a mix between Tagalog, English and Hokkien. It is practiced typically in social circles, homes and business contexts. In homes and social circles specifically, terms such as “Ahya” and “Achi” are used to refer to siblings or people with relations to the speaker. Moreover, the Hokkien language has been integrated into the Philippine vocabulary , with words such as “susi” and “miswa” having their roots in the Hokkien language.</p>
            
            <h4 class="text-white">Common Misunderstandings</h4>
            <ul>
              <li><strong>Old-fashioned and outdated:</strong> It was used commonly by most Chinese-Filipino ancestors and older generations as a once effective method of communication. In the current period of globalization and distribution of knowledge, using this language seems to be less important. Moreover, it has been seeing a decline in recent Chinese-Filipinos due to the language being taught less as compared to other languages such as English and Mandarin. Although these reasons are valid to their own extent, the Hokkien language is still a language that can change as the world progresses. The Hokkien once brought by our ancestors has changed over and over again; maintaining its core structures but developing new ways to use the language depending on the context ensures its survival </li>
              <li><strong>Inferior to Mandarin:</strong> Hokkien has been seeing a decline in usage and is seen as inferior to Mandarin as governments of Chinese-speaking nations have been actively promoting Mandarin as the main Sinitic language in formal settings and public spaces. Though this mindset doesn’t stem from the Tsinoy community, it has affected the overall use of Hokkien by a decline. The “uniformity” advocated by these governments were taken as the superiority of the Mandarin language, which isn’t accurate as both are Chinese languages that have created a cultural impact on their respective communities.</li>
              <li><strong>Just another dialect of Mandarin:</strong> Hokkien doesn’t have a writing system that fully caters to its unique aspects — it shares the same Chinese Characters typically associated with Mandarin. This is false because of their distinct origins, grammatical structures and vocabulary.</li>
              <li><strong>Spoken by all Chinese-Filipinos:</strong> The majority of the Chinese-Filipino population comes from the southern region of China and somehow have roots to this language, however there are still some populations living in the Philippines who are of Cantonese or Mandarin descent.</li>
            </ul>

            <h4 class="text-white">Importance and Significance</h4>
            <p>Hokkien is essential to Philippine society as it has contributed greatly to the development of the modern Tagalog vocabulary, Filipino culture and economy. As stated previously, words such as “suki” and “pancit” stem from this language, these words have also left an indelible mark on culture and business through ways such as the “suki” relationships and food such as pancit becoming staples of everyday Philippine culture.</p>
